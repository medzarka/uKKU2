...
SITE_ADMIN_TEMPLATE = env('SITE_ADMIN_TEMPLATE')
GRAPPELLI_ADMIN_TITLE = env('SITE_ADMIN_SITE_TITLE')
ADMIN_SITE_SITE_HEADER = env('SITE_ADMIN_SITE_HEADER')
ADMIN_SITE_INDEX_TITLE = env('SITE_ADMIN_SITE_INDEX_TITLE')
ADMIN_SITE_SITE_TITLE = env('SITE_ADMIN_SITE_TITLE')
