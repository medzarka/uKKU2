...
var OrgChart = function (b, a) {
    ...
    this.config = {
        ...
        UI: null,
        anim: {func: BALKANGraph.anim.outPow, duration: 200},
        onUpdate: "",
        onRemove: "",
        onAdd: "",
        onRedraw: "",
...
OrgChart.prototype._p = function (t, a, c, g) {
    ...
    if (a === BALKANGraph.action.centerNode) {
        BALKANGraph.anim(this.getSvg(), {viewbox: s}, {viewbox: this.response.viewBox}, this.config.anim.duration, this.config.anim.func, function () {
        ...
        if (s && this.response && (s[0] != this.response.viewBox[0] || s[1] != this.response.viewBox[1] || s[2] != this.response.viewBox[2] || s[3] != this.response.viewBox[3]) && (a === BALKANGraph.action.insert || a === BALKANGraph.action.expandCollapse || a === BALKANGraph.action.update || a === BALKANGraph.action.init)) {
            BALKANGraph.anim(this.getSvg(), {viewbox: s}, {viewbox: this.response.viewBox}, 500, BALKANGraph.anim.inOutPow, function () {
                x.xScrollUI.setPosition();
                x.yScrollUI.setPosition();
                if (!j) {
                    if (g) {
...
OrgChart.prototype.ripple = function (g, b, c) {
    ...
    n.appendChild(k);
    i.appendChild(n);
    BALKANGraph.anim(k, {r: 0, opacity: 1}, {r: j, opacity: 0}, 500, BALKANGraph.anim.outPow, function () {
        i.removeChild(n)
    })
};
OrgChart.prototype.center = function (b, c, a, d) {
    this._p(false, BALKANGraph.action.centerNode, {id: b, parentState: c, childrenState: a, rippleId: d})
};
...
OrgChart.prototype.linkNode = function (b, j) {
    if (this._g(b, j)) {
        ...
        var h = this;
        this._p(false, BALKANGraph.action.update, {visId: b}, function () {
            h.ripple(c.id)
        })
    }
};
OrgChart.prototype.updateNode = function (b, a) {
    ...
    if (this.update(b, a)) {
        ...
        this._p(false, BALKANGraph.action.update, {id: c}, function () {
            d.ripple(b.id)
        })
    }
};
...
OrgChart.prototype.addNode = function (d, b) {
    ...
    f._p(false, a, {id: c, insertedNodeId: d.id})
};
...
OrgChart.prototype._aL = function (a, b, f) {
    ...
    this.config.tags = d;
    var e = this;
    this._p(false, BALKANGraph.action.update, {id: a}, function () {
        e.ripple(a)
    })
};
...
OrgChart.prototype.group = function (h, l) {
    ...
    if (!g.isGroup && !k.isGroup && !g.isChildOfGroup && !k.isChildOfGroup) {
        ...
        this.addTag(c, {group: true, groupName: "", groupState: BALKANGraph.EXPAND, template: "group_grey"}, true);
    ...
    this._p(false, BALKANGraph.action.update, {id: e}, function () {
        m.ripple(g.id)
    })
};
...
OrgChart.prototype._ai = function (k, c, g) {
    ...
    var l = {diffX: 0, diffY: 0, x0: a.x, y0: a.y, type: "pan", viewBoxLeft: n[0], viewBoxTop: n[1]};
    ...
    if (l.type == "pan") {
        ...
        BALKANGraph.anim(i, {transform: [0, 0, 0, 0, o, p], opacity: 0}, {
...
BALKANGraph.input = function (f, k, h, i, e, c) {
    ...
    if (!i) {
        d.addEventListener("focus", function () {
            ...
            BALKANGraph.anim(m, {width: 10}, {width: l.clientWidth}, 250, BALKANGraph.anim.inOutSin)
        })
    }
    ...
    if (BALKANGraph.addValidation) {
        var a = {wrapper: l, label: g, input: d, hr: b};
...
OrgChart._s = function (c, e, b, f, a) {
    ...
    e.push([[c.x - b.levelSeparation / 3], g]);
    d = e[e.length - 1][0];
    s = g;
    f.p = d;
    f.q = g;
...
OrgChart._x = function (c, e, b, f, a) {
    ...
    e.push([e[e.length - 1][0], g]);
    e.push([[c.x + c.w + b.levelSeparation / 3], g]);
    d = e[e.length - 1][0];
    s = g;
    f.p = d;
    f.q = g;
...
OrgChart.editUI.prototype._j = function (h, b) {
    ...
    Object.assign(c.style, {"overflow-x": "hidden", "overflow-y": "auto"});
    ...
    Object.assign(m.style, {margin: "12px"});
    ...
    if (h.isGroup) {
        d = ["Name"];
        a = {Name: this.obj.config.tags[h.id].groupName}
    }
    ...
    this.obj._0();
    BALKANGraph.anim(this.wrapperElement, {right: -150, opacity: 0}, {
        right: 0,
        opacity: 0.9
...
OrgChart.editUI.prototype._m = function (l, e) {
    ...
    Object.assign(f.style, {"overflow-x": "hidden", "overflow-y": "auto"});
    ...
    Object.assign(a.style, {margin: "14px 14px 7px", color: "#4285F4", cursor: "pointer"});
    Object.assign(b.style, {margin: "14px 14px 7px", color: "rgb(188, 188, 188)"});
    ...
    if (l.isGroup) {
        g = ["Name"];
        d = {Name: this.obj.config.tags[l.id].groupName}
    }
    ...
    a.addEventListener("click", function () {
        if (a.innerHTML == "Save") {
            BALKANGraph.anim(a, {opacity: 1}, {opacity: 0}, 200, BALKANGraph.anim.inSin, function () {
                a.innerHTML = "Add new field";
                ...
                if (q && !BALKANGraph._r(n.fields, q)) {
                    ...
                    r.style.opacity = 0;
                    f.insertBefore(r, a);
                    BALKANGraph.anim(r, {opacity: 0}, {opacity: 1}, 200, BALKANGraph.anim.inSin, function () {
                        r.getElementsByTagName("input")[0].focus()
                    })
                }
                BALKANGraph.anim(a, {opacity: 0}, {opacity: 1}, 200, BALKANGraph.anim.inSin)
            })
        } else {
            BALKANGraph.anim(a, {opacity: 1}, {opacity: 0}, 200, BALKANGraph.anim.inSin, function () {
                a.innerHTML = "Save";
            ...
            i.id = "bgNewField";
            f.appendChild(i);
            BALKANGraph.anim(i, {opacity: 0}, {opacity: 1}, 200, BALKANGraph.anim.inSin, function () {
...
OrgChart.editUI.prototype.hide = function (f) {
    ...
    if (this.node.isGroup) {
        b = {Name: this.obj.config.tags[this.node.id].groupName}
    }
    if (f) {
        ...
        var g = this;
        this.obj._0();
        BALKANGraph.anim(g.wrapperElement, {right: 0, opacity: 1}, {
            right: -150,
            opacity: 0
        }, 300, BALKANGraph.anim.inOutSin, function () {
            g.obj._aM();
...
OrgChart.ui = {
    _k: {}, defs: function () {
        ...
        for (var g = 0; g < a.children.length; g++) {
            var b = a.children[g];
            var m = {xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0};
        ...
        var g = 0, l = 0, h = 0, m = 0, i = 0, n = 0, j = 0, o = 0, f = 0, k = 0, c = 0;
        ...
        f = i;
        k = n + 16;
        return {xa: g, ya: l, xb: h, yb: m, xc: i, yc: n, xd: j, yd: o, x: f, y: k, rotate: c}
...
BALKANGraph.menuUI.prototype.show = function (n, o, b, j, h) {
    ...
    if (c != "") {
        ...
        BALKANGraph.anim(this.wrapper, {opacity: 0, left: k - this.wrapper.offsetWidth}, {
            opacity: 1,
            left: a
        ...
        for (var d = 0; d < g.length; d++) {
            ...
            f.addEventListener("click", function () {
                ...
                if (r === undefined) {
                    if (q === "add") {
                        var p = {id: BALKANGraph._aX(), pid: b};
...
BALKANGraph.toolbarUI.prototype.showLayout = function () {
    ...
    BALKANGraph.anim(this.div, {bottom: this.obj.config.padding}, {bottom: this.obj.config.padding + 145}, this.obj.config.anim.duration, this.obj.config.anim.func);
    BALKANGraph.anim(this.layouts, {bottom: -145}, {bottom: 0}, this.obj.config.anim.duration, this.obj.config.anim.func)
};
BALKANGraph.toolbarUI.prototype.hideLayout = function () {
    ...
    BALKANGraph.anim(this.div, {bottom: this.obj.config.padding + 145}, {bottom: this.obj.config.padding}, this.obj.config.anim.duration, this.obj.config.anim.func);
    BALKANGraph.anim(this.layouts, {bottom: 0}, {bottom: -145}, this.obj.config.anim.duration, this.obj.config.anim.func)
};
...
OrgChart.server.prototype._aE = function () {
    ...
    var a = {minX: null, minY: null, maxX: null, maxY: null};
    for (var b in d) {
        var c = d[b];
        OrgChart.server._aN(c, a)
    }
    return {minX: a.minX, minY: a.minY, maxX: a.maxX, maxY: a.maxY, nodes: d, roots: f, groupChildren: e.groupChildren}
};
...
OrgChart.server._i = function (q, a, b, L) {
    ...
    for (var A = 0; A < f.length; A++) {
        ...
        if (e.length % 2) {
            ...
            OrgChart.templates[aa] = {linkAdjuster: {}, link: "", node: "", nodeMenuButton: "", size: W.size};
    ...
    return {nodes: I, roots: Q, groupChildren: w}
};
...
OrgChart.server._K = function (L, o, E, j, s, t, u, v, I, l, c, d, B, m, D) {
    var J = {};
    var f = {top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null};
    var e = [[], [], []];
        ...
        if (OrgChart.server._ar(A, j, I, c)) {
            ...
            if (c == BALKANGraph.action.expandCollapse && D && D[A.id]) {
                ...
                if (i) {
                    ...
                    if (F) {
                        b = {x: i.x + i.w / 2 - A.w / 2, y: i.y + i.h / 2 - A.h / 2}
                    }
                }
            } else {
                if (c == BALKANGraph.action.centerNode && D && D[A.id]) {
                    ...
                    if (g) {
                        var F = A.parent;
                        if (F && F.id == d.id) {
                            b = {x: g.x + g.w / 2 - A.w / 2, y: g.y + g.h / 2 - A.h / 2}
                        }
                    }
                } else {
            ...
            if (b != null) {
                if (b.x != A.x || b.y != A.y) {
                    e[0].push(A.id);
                    e[1].push({transform: [1, 0, 0, 1, b.x, b.y]});
                    e[2].push({transform: [1, 0, 0, 1, A.x, A.y]})
                }
            }
        }
    }
    return {animations: e, boundary: f, viewBox: I, visibleNodes: J, allFields: OrgChart.server.getAllFields(j)}
};
...
BALKANGraph._al = function (e, d, a, b) {
    ...
    if (d[0] !== c[0] || d[1] !== c[1]) {
        BALKANGraph.anim(e, {viewBox: d}, {viewBox: c}, 300, BALKANGraph.anim.outPow, function () {
            if (b) {
                b()
            }
        })
...
BALKANGraph._q = function (a) {
    return '<a style="text-decoration: none;position:absolute;bottom:' + a + "px;left:" + a + 'px;" title="OrgChart | BALKANGraph" href="https://BALKANGraph.com"><span style="color:#039BE5;font-family:Roboto,Roboto-Regular,Helvetica;font-weight:bold;"></span><span style="color:#F57C00;font-family:Roboto,Roboto-Regular,Helvetica;"></span></a>'
};
...
BALKANGraph._R = function (a) {
    if (a.type.indexOf("touch") != -1) {
        if (a.changedTouches.length) {
            return {x: a.changedTouches[0].clientX, y: a.changedTouches[0].clientY}
        }
    } else {
...
BALKANGraph._C = function (a, b) {
    if (a.type.indexOf("touch") != -1) {
        if (a.touches.length < b + 1) {
            ...
            return {x: a.touches[b].clientX, y: a.touches[b].clientY}
        }
    } else {
        return {x: a.clientX, y: a.clientY}
    }
...
BALKANGraph._U = function (b, a) {
    if (a.type.indexOf("touch") != -1) {
        if (a.touches.length) {
            ...
            return {x: a.touches[0].pageX - c.x, y: a.touches[0].pageY - c.y}
        } else {
            if (a.changedTouches.length) {
                var c = BALKANGraph._1(b);
                return {x: a.changedTouches[0].pageX - c.x, y: a.changedTouches[0].pageY - c.y}
            }
        }
    } else {
...
OrgChart.prototype._5 = function (d, a) {
    var b = {move: "mousemove", up: "mouseup", leave: "mouseleave"};
    if (a.type.indexOf("touch") != -1) {
        if (a.touches.length == 1) {
            this._aK = {x: a.touches[0].clientX, y: a.touches[0].clientY}
        } else {
            this._aK = null
        }
        b = {move: "touchmove", up: "touchend", touchstart: "touchstart"}
    }
    if (d == a.target) {
        a.stopPropagation();
        a.preventDefault();
...
OrgChart.prototype._3 = function (i, a) {
    if (a.type.indexOf("touch") != -1 && this._aK && a.changedTouches.length == 1) {
        if (a.changedTouches.length) {
            var j = {x: a.changedTouches[0].clientX, y: a.changedTouches[0].clientY};
...
OrgChart.prototype.zoom = function (b, a, d) {
    ...
    if (((b === true) && (c < this.config.scaleMax)) || ((b === false) && (c > this.config.scaleMin)) || (b != false && b != true && c < this.config.scaleMax && c > this.config.scaleMin)) {
        ...
        if (d) {
            clearTimeout(h._aI);
            BALKANGraph.anim(this.getSvg(), {viewbox: this.getViewBox()}, {viewbox: i}, this.config.anim.duration, this.config.anim.func, function () {
                clearTimeout(h._aI);
...
OrgChart.searchUI.prototype.hide = function () {
    ...
    if (d.style.display != "none" && c.style.display != "none") {
        BALKANGraph.anim(d, {opacity: d.style.opacity}, {opacity: 0}, 200, BALKANGraph.anim.inOutSin, function () {
            d.style.display = "none";
            BALKANGraph.anim(c, {width: 300, opacity: 1}, {
                width: 50,
                opacity: 0
...
OrgChart.searchUI.prototype.show = function (a) {
    ...
    b.style.display = "block";
    b.style.opacity = 0;
    BALKANGraph.anim(b, {width: 50, opacity: 0}, {width: 300, opacity: 1}, 300, BALKANGraph.anim.outBack, function () {
        c.style.display = "inherit";
        c.style.opacity = 0;
        BALKANGraph.anim(c, {opacity: 0}, {opacity: 1}, 200, BALKANGraph.anim.inOutSin);
        if (a) {
            a()
        }
    })
